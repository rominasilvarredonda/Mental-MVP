...
export const wizardQuestions: WizardQuestion[] = [
  ...
  { id: "stress", title: "¿Cómo te has sentido últimamente en relación al estrés o la ansiedad?", options: ["Me siento tranquilo/a la mayor parte del tiempo", "Tengo estrés ocasional, manejable", "Me siento bastante estresado/a o ansioso/a", "Me siento muy sobrepasado/a por el estrés o la ansiedad", "Prefiero no responder"], layout: "stacked" },
  { id: "mood", title: "¿Cómo ha estado tu estado de ánimo últimamente?", options: ["Me siento bien la mayor parte del tiempo", "A veces me siento bajo/a de ánimo", "Me siento desmotivado/a o triste con frecuencia", "Me siento muy decaído/a o sin energía la mayor parte del tiempo", "Prefiero no responder"], layout: "stacked" },
  { id: "support-network", title: "¿Cómo te sentís en cuanto a tu entorno o compañía actualmente?", options: ["Me siento acompañado/a y con buen apoyo", "A veces me siento solo/a", "Me siento bastante solo/a o desconectado/a", "Me siento muy solo/a la mayor parte del tiempo", "Prefiero no responder"], layout: "stacked" },
